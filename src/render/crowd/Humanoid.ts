...
const SKELETON: BoneSpec[] = [
  { name: 'pelvis', parent: null, offset: [0, 0.94, 0], size: [0.32, 0.24, 0.2], centre: [0, 0, 0] },
  { name: 'torso', parent: 'pelvis', offset: [0, 0.12, 0], size: [0.42, 0.56, 0.24], centre: [0, 0.28, 0] },
  { name: 'head', parent: 'torso', offset: [0, 0.56, 0], size: [0.22, 0.26, 0.24], centre: [0, 0.15, 0] },

  { name: 'armUpperL', parent: 'torso', offset: [0.26, 0.48, 0], size: [0.12, 0.3, 0.12], centre: [0, -0.15, 0] },
  { name: 'armLowerL', parent: 'armUpperL', offset: [0, -0.3, 0], size: [0.1, 0.3, 0.1], centre: [0, -0.15, 0] },
  { name: 'armUpperR', parent: 'torso', offset: [-0.26, 0.48, 0], size: [0.12, 0.3, 0.12], centre: [0, -0.15, 0] },
  { name: 'armLowerR', parent: 'armUpperR', offset: [0, -0.3, 0], size: [0.1, 0.3, 0.1], centre: [0, -0.15, 0] },

  { name: 'legUpperL', parent: 'pelvis', offset: [0.11, -0.12, 0], size: [0.15, 0.42, 0.16], centre: [0, -0.21, 0] },
  { name: 'legLowerL', parent: 'legUpperL', offset: [0, -0.42, 0], size: [0.13, 0.42, 0.15], centre: [0, -0.21, 0] },
  { name: 'legUpperR', parent: 'pelvis', offset: [-0.11, -0.12, 0], size: [0.15, 0.42, 0.16], centre: [0, -0.21, 0] },
  { name: 'legLowerR', parent: 'legUpperR', offset: [0, -0.42, 0], size: [0.13, 0.42, 0.15], centre: [0, -0.21, 0] },
];
